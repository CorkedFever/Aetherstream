...
| Stories | The bard's hour: a tonberry in a chair by a fire with a lantern, a tale a time in six pages, each read from the chair then shown as a picture: a hero of one of the peoples, a road between places that exist, a beast from the bestiary, a treasure from the item table, a god from the Twelve; he ends every tale the same way and you don't have to take his word for it | The outdoor zones and their regions, the hunting log, and the item table; the pages are written and seeded by the tale |
