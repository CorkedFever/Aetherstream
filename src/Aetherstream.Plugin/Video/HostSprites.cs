...
internal static class HostSprites
{
    ...
    [
        [
            ...
            ".......iiiiiiiii........",
            "..II...yyyyyyyy...II....",
            ".IIII.yyyyyyyyyy.IIII...",
            ".IIIIIyyyyyyyyyyIIIII...",
            ".IIIIiiyyyyyyyyyyiiIII..",
            "..IIIiiyyyyyyyyyyiiII...",
            "...II.yyyyyyyyyyyy.I....",
            "......yyyyyyyyyyyy......",
            "......yyyyyyyyyyyy......",
    ...
    public static void DrawCast(Span<uint> target, int who, bool walk, double seconds, int x, int y, int scale, bool flip = false)
    {
        switch (who % 6)
        {
            ...
            case 3:
                ...
                Costume(target, x, y, scale, flip, 24, 7, 2, 10, 1, Crown);
                Costume(target, x, y, scale, flip, 24, 7, 1, 1, 1, Crown);
                Costume(target, x, y, scale, flip, 24, 11, 0, 2, 2, Crown);
                Costume(target, x, y, scale, flip, 24, 16, 1, 1, 1, Crown);
                break;
            case 4:
