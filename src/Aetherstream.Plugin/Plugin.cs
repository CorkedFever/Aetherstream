...
public sealed partial class Plugin : IDalamudPlugin
{
        ...
        IPluginLog log)
    {
        ...
        [
            ...
            ("Radio", "Aether FM: the set's own jukebox on screen, with a spectrum that moves to it.", "Music", new MusicChannel(face, () => new MusicState(this.session.MusicPlaying, this.session.MusicNowPlaying, this.session.MusicUpNext, this.session.MusicPosition.Index, this.session.MusicPosition.Count), buf => this.session.MusicTap(buf))),
